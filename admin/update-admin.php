...
if (isset($_POST['submit_admin'])) {
    ...
    if (!$res == true) {
        ...
        $_SESSION['update'] = "<div class='error'>Échec de la suppression de l'administrateur.</div>";
        //Redirection vers la page d'administration de la gestion
        header('location:' . SITEURL . 'admin/manage-admin.php');
    }

    $_SESSION['update'] = "<div class='success'>Succès de la mise à jour de l'Admin.</div>";
    header('location:' . SITEURL . 'admin/manage-admin.php');
}
?>
